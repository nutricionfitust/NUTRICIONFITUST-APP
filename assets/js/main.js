...
const exerciseDatabase = {
  piernas_general: [
    ...
    { name: "Prensa", videoId: "1O-YMrJVc7pndxpuATZbXboeulDQ5kxS0", description: "Ejercicio en máquina que permite trabajar cuádriceps y glúteos con cargas altas de forma segura." },
    { name: "Sentadilla Búlgara con Barra", videoId: "1bcNRv0NWafCWN4fOvb0hzJLBpMw4qwwf", description: "Sentadilla unilateral con barra y pie trasero elevado. Desarrolla fuerza, equilibrio y corrige desequilibrios." },
    { name: "Sentadilla Búlgara con Mancuernas", videoId: "1VkcnF9SA-YNYQazHOPzGiGZGWPawJ6Od", description: "Variante con mancuernas más accesible para principiantes. Excelente para cuádriceps y glúteos." },
    { name: "Sentadilla Búlgara en Smith", videoId: "1GKxgnnkTyBZoxVCy4ynY1VgpomFN0Xfu", description: "Sentadilla búlgara en máquina Smith para mayor estabilidad y control del movimiento." },
    { name: "Sentadillas", videoId: "1JJjXOHws6I_5XXMLgyTenU_tdDynfhiY", description: "El ejercicio rey para el desarrollo de piernas. Trabaja cuádriceps, glúteos, isquiotibiales y core." },
    { name: "Tracción con Barra en Rack", videoId: "1c0rJzJ3VDuIqTh1rJLIEHUkSovgeLBfn", description: "Ejercicio de tracción horizontal que fortalece espalda y mejora la postura corporal." }
  ],
  cuadriceps: [
