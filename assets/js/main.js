...
const exerciseDatabase = {
  ...
  cuadriceps: [
    { name: "Estocadas Caminando con Mancuernas", videoId: "https://drive.google.com/file/d/1lq4UD_oqMliGlhKZ9t660RVQS4C-pvYI/view?usp=drivesdk", description: "Ejercicio dinámico que trabaja cuádriceps, glúteos y estabilidad. Camina hacia adelante alternando piernas." },
    { name: "Estocadas con Barra", videoId: "https://drive.google.com/file/d/1dLEdj1RnS4MjDJPkeNe-JWIBsmB6yeS2/view?usp=drivesdk", description: "Estocadas estáticas con barra en la espalda. Excelente para fuerza y masa muscular en cuádriceps." },
    { name: "Estocadas en Cajón con Barra", videoId: "https://drive.google.com/file/d/1EY6HibAVLeP8YjrghGgMpJvRwp-gZFo2/view?usp=drivesdk", description: "Variante elevada que aumenta el rango de movimiento y la activación del cuádriceps." },
    { name: "Estocadas en Smith", videoId: "https://drive.google.com/file/d/1dlBtABwW52_JcOt0U_H-308HrKYT85PD/view?usp=drivesdk", description: "Estocadas en máquina Smith para mayor estabilidad y control del movimiento." },
    { name: "Estocadas Hacia Atrás con Mancuernas", videoId: "https://drive.google.com/file/d/19XjPqTcYstRyQx54wfJBpqBkhTuKUxP8/view?usp=drivesdk", description: "Estocadas inversas que enfatizan el cuádriceps y reducen el estrés en las rodillas." },
    { name: "Extensión de Cuádriceps Sentado", videoId: "https://drive.google.com/file/d/1T8t9ijRwlMtma4bOkoJh3aOiy5nxEzoJ/view?usp=drivesdk", description: "Ejercicio de aislamiento para cuádriceps en máquina. Ideal para definición muscular." },
    { name: "Sentadillas en Hack", videoId: "https://drive.google.com/file/d/1hSkUvjYajDfj8H2aMbIjHEef8v7nP6DP/view?usp=drivesdk", description: "Sentadillas en máquina hack que permite cargar más peso con mayor seguridad." },
    { name: "Sentadillas en Smith", videoId: "https://drive.google.com/file/d/1WQPQoAHSwoyHccV5u-OP1e1p7MhEX5_E/view?usp=drivesdk", description: "Sentadillas en máquina Smith para principiantes o entrenamiento con mayor control." },
    { name: "Sentadillas Frontales", videoId: "https://drive.google.com/file/d/1y0w4ZGpMrl-xdws2aI0qF8GIvcKzgM4w/view?usp=drivesdk", description: "Variante con barra al frente que enfatiza más el cuádriceps y mejora la postura." },
    { name: "Sentadillas Frontales en Smith", videoId: "https://drive.google.com/file/d/1_5Ke5te3PGmPWiwEf86TLZwfg7Howyy9/view?usp=drivesdk", description: "Variante con barra al frente que enfatiza más el cuádriceps y mejora la postura." },    
    { name: "Sentadilla Búlgara con Mancuernas", videoId: "https://drive.google.com/file/d/1VkcnF9SA-YNYQazHOPzGiGZGWPawJ6Od/view?usp=drivesdk", description: "Variante accesible que mantiene el mismo estímulo unilateral. Enfocada en cuádriceps y glúteos, permite mayor control del movimiento y es excelente para trabajar al fallo con seguridad." },
    { name: "Sentadilla Búlgara en Smith", videoId: "https://drive.google.com/file/d/1GKxgnnkTyBZoxVCy4ynY1VgpomFN0Xfu/view?usp=drivesdk", description: "Opción guiada que suma estabilidad y control, sin perder el estímulo intenso sobre cuádriceps y glúteos. Permite bajar profundo, cargar más y enfocarse en la contracción sin preocuparse por el equilibrio." },
  ],
  gluteos: [
    { name: "Hip Thrust con Barra", videoId: "https://drive.google.com/file/d/1gKxoZqdESY6vpSnIvvZKjN1a1agdJAci/view?usp=drivesdk", description: "El mejor ejercicio para activar y desarrollar los glúteos. Movimiento de extensión de cadera." },
    { name: "Hip Thrust en Smith", videoId: "https://drive.google.com/file/d/1fcOHHb6YXseRaX915WdGt63f_hCpNd9F/view?usp=drivesdk", description: "Hip thrust en máquina Smith para mayor estabilidad y control del peso." },
    { name: "Hiperextensión 45 Grados Glúteos", videoId: "https://drive.google.com/file/d/1mcMH-_YV4T6eGWYM9UNNF5p7_7a7odeX/view?usp=drivesdk", description: "Hiperextensiones enfocadas en glúteos con técnica específica para máxima activación." },
    { name: "Sentadillas Sumo con Barra", videoId: "https://drive.google.com/file/d/1ijW2ft50ijZHSYpeHHucUNmt_f7WPz9I/view?usp=drivesdk", description: "Sentadillas con stance amplio que enfatiza glúteos y aductores." },
        { name: "Sentadillas Sumo con Mancuerna", videoId: "https://drive.google.com/file/d/1gsNRrtMEClU8Ze2p16v7Iw9KP8_AAokY/view?usp=drivesdk", description: "Sentadillas con stance amplio que enfatiza glúteos y aductores." },
  ],
  isquiotibiales: [
    { name: "Isquiotibiales Acostado", videoId: "https://drive.google.com/file/d/1odYrViuAw6cmLfBHLcdmXf9ZCwFArVn5/view?usp=drivesdk", description: "Curl de isquiotibiales en máquina acostado. Ejercicio de aislamiento efectivo." },
    { name: "Isquiotibiales Sentado", videoId: "https://drive.google.com/file/d/1zAQmYSac4XFv5XI6Q8XT8PM62uAWCktk/view?usp=drivesdk", description: "Curl de isquiotibiales en posición sentada. Variante que cambia el ángulo de trabajo." },
    { name: "Peso Muerto Convencional", videoId: "https://drive.google.com/file/d/1aPLT_cpIJsnW3ECUt4SuMFcbmq_uf-Em/view?usp=drivesdk", description: "Ejercicio fundamental que trabaja toda la cadena posterior: isquios, glúteos y espalda." },
    { name: "Peso Muerto en Smith", videoId: "https://drive.google.com/file/d/1c4Jo6YVM9U3fnX3h3Sd5XF0Khz5czfFg/view?usp=drivesdk", description: "Peso muerto en máquina Smith para mayor control y seguridad." },
    { name: "Peso Muerto Rumano con Mancuernas", videoId: "https://drive.google.com/file/d/1q6qQz9xBcp4flUc56_NFAAXLHT--QjJl/view?usp=drivesdk", description: "Variante con mancuernas que enfatiza el estiramiento de isquiotibiales." },
    { name: "Peso Muerto Rumano con Barra", videoId: "https://drive.google.com/file/d/1-js5MRBFdvc0_ndj-JcGQvvshafVfkML/view?usp=drivesdk", description: "Peso muerto rumano clásico. Excelente para isquiotibiales y glúteos." },
    { name: "Peso Muerto Sumo", videoId: "https://drive.google.com/file/d/1VwAWOXxQ8yKTP1pH3F_4Lz0wA7DqxxVR/view?usp=drivesdk", description: "Variante sumo que permite levantar más peso y enfatiza glúteos." },
    { name: "Peso Muerto Unilateral con Mancuerna", videoId: "https://drive.google.com/file/d/1GIX9pgMkaB2dJ4m_kxutVxeZ8U5aHl25/view?usp=drivesdk", description: "Peso muerto a una pierna que mejora equilibrio y trabaja isquios unilateralmente." },
  ],
  pantorrillas: [
    { name: "Gemelos de Pie en Máquina", videoId: "https://drive.google.com/file/d/1aQETMdpISa2jkX-xavke3vrNxDkLNWsS/view?usp=drivesdk", description: "Ejercicio clásico para gemelos en máquina específica. Permite cargas altas." },
    { name: "Gemelos de Pie en Smith", videoId: "https://drive.google.com/file/d/18cuDm9I82ayxF4hSlcQpaQr45T77M3gn/view?usp=drivesdk", description: "Elevaciones de gemelos usando la máquina Smith para estabilidad." },
    { name: "Gemelos en Prensa", videoId: "https://drive.google.com/file/d/1RkueB6PvBvuPz_RGfh3Hl70qWxGvqi_L/view?usp=drivesdk", description: "Gemelos en máquina de prensa. Variante cómoda y efectiva." },
    { name: "Sóleo Sentado con Mancuerna Unilateral", videoId: "https://drive.google.com/file/d/1XV-CutHJNkqvY7fSJaMLfKvlHUe2EMqY/view?usp=drivesdk", description: "Trabajo unilateral del sóleo con mancuerna. Permite corregir desequilibrios." },
    { name: "Sóleo Sentado en Máquina", videoId: "https://drive.google.com/file/d/1J7hUeQvPKwawBx0jLgWB5hfuM8DJKK21/view?usp=drivesdk", description: "Ejercicio específico para el músculo sóleo en máquina sentado." },
    { name: "Sóleo Sentado con Mancuernas", videoId: "https://drive.google.com/file/d/1qNB7Mbho6e87D3JqxBXzrjIKM8RgcfTQ/view?usp=drivesdk", description: "Trabajo del sóleo con mancuernas en posición sentada." },
  ],
  pectorales: [
    { name: "Aperturas de Pie con Poleas", videoId: "https://drive.google.com/file/d/1YvjiQlolKpKn3DQ8RY2REs56zhyr4Twj/view?usp=drivesdk", description: "Aperturas de pie en polea que permiten trabajar el pecho desde un ángulo único con resistencia constante." },
    { name: "Aperturas en Banca con Mancuernas", videoId: "https://drive.google.com/file/d/1e0QWbSnb4TfNX2nn8bzzeIQR1FxkLHdx/view?usp=drivesdk", description: "Ejercicio clásico de aislamiento para pectorales. Proporciona un estiramiento profundo y contracción intensa." },
    { name: "Aperturas en Banca Inclinado con Mancuernas", videoId: "https://drive.google.com/file/d/1QadKUn1fZcpZjJJUajfcxMR2lsKIrMhS/view?usp=drivesdk", description: "Aperturas inclinadas que enfatizan la porción superior del pectoral con mayor estiramiento." },
    { name: "Aperturas Sentado en Máquina", videoId: "https://drive.google.com/file/d/1-2WvTtJ9Rcp84JA-WiV9RxowNBqW7kOd/view?usp=drivesdk", description: "Aperturas en máquina que proporcionan un movimiento guiado y seguro para el aislamiento del pecho." },
    { name: "Flexiones BB Amplias (Pecho)", videoId: "https://drive.google.com/file/d/1C5XkxyDmjH3FmhAucPBrXT9EzY4_pVy4/view?usp=drivesdk", description: "Flexiones con agarre amplio que enfatizan el trabajo de los pectorales sobre tríceps." },
    { name: "Flexiones BB con Rodillas Apoyadas", videoId: "11_NOPs-https://drive.google.com/file/d/1x7VwrtJ-l9ZuQjx5bOzC3VDn-PaBnz5l/view?usp=drivesdk", description: "Variante modificada de flexiones ideal para principiantes o cuando se busca menor intensidad." },
    { name: "Flexiones BB Declinado", videoId: "https://drive.google.com/file/d/1dniWxfrI77S5zUw0vtOGpISbyifiF4Eh/view?usp=drivesdk", description: "Flexiones con pies elevados que aumentan la dificultad y enfatizan la porción superior del pecho." },
    { name: "Flexiones BB Inclinado", videoId: "https://drive.google.com/file/d/12NqNrFdHV3C2pZop4CSocxjW18UAEQip/view?usp=drivesdk", description: "Flexiones con manos elevadas que reducen la dificultad y son ideales para principiantes." },
    { name: "Flexiones BB Profundas", videoId: "https://drive.google.com/file/d/10Ow9-8p-hG2JDbRVYF4wfAmQNWra3_53/view?usp=drivesdk", description: "Flexiones con mayor rango de movimiento que proporcionan un estiramiento más profundo del pecho." },
    { name: "Flexiones BB", videoId: "https://drive.google.com/file/d/1t8WpW9earph-8i_7R3apxC8laS9cjAsd/view?usp=drivesdk", description: "Flexiones clásicas con peso corporal. Ejercicio fundamental y versátil para desarrollo del pecho." },
    { name: "Fondos para Pecho", videoId: "https://drive.google.com/file/d/1Id235vxbnHTg9FirBqaK3UoGo-7YIF-v/view?usp=drivesdk", description: "Fondos en paralelas enfocados en pectorales. Excelente ejercicio con peso corporal para masa y fuerza." },
    { name: "Fondos Sentado en Máquina", videoId: "https://drive.google.com/file/d/14vrZVe2Jv0psm3O7oot-tmpJ-I5rcW01/view?usp=drivesdk", description: "Fondos en máquina sentado que proporcionan soporte y control del movimiento para mayor seguridad." },
    { name: "Peck Deck", videoId: "https://drive.google.com/file/d/1DoDvxFJxur603NTiaqNY6tLo1Xf0azMz/view?usp=drivesdk", description: "Ejercicio en máquina peck deck que aísla perfectamente los pectorales con movimiento guiado." },
    { name: "Press Banca con Mancuernas", videoId: "https://drive.google.com/file/d/1v17dS875CBZJTn2g3BmrN1kr1UiTZhRx/view?usp=drivesdk", description: "Press de banca con mancuernas que permite mayor rango de movimiento y trabajo independiente de cada brazo." },
    { name: "Press Banca en Smith", videoId: "https://drive.google.com/file/d/1Rh3w4gsBNZiW1t_MlBjn0Ts7qmy-BdR2/view?usp=drivesdk", description: "Press de banca en máquina Smith que proporciona mayor estabilidad y seguridad durante el ejercicio." },
    { name: "Press Banca Inclinado con Mancuernas", videoId: "https://drive.google.com/file/d/1JHa8aWpRj6Xb-yvFFunIfVD02y7Z5OQr/view?usp=drivesdk", description: "Press inclinado con mancuernas que enfatiza la porción superior del pectoral con mayor libertad de movimiento." },
    { name: "Press Banca Inclinado en Smith", videoId: "https://drive.google.com/file/d/1kPXVZvhTC1iG31uM7roy6N7_FTlnSD5i/view?usp=drivesdk", description: "Press inclinado en máquina Smith que combina los beneficios del ángulo inclinado con la estabilidad de la máquina." },
    { name: "Press Banca Inclinado", videoId: "https://drive.google.com/file/d/11_NOPs-spDqtlbvosMbgEIUl2gLLSDTk/view?usp=drivesdk", description: "Press de banca inclinado clásico con barra que desarrolla la porción superior del pectoral." },
    { name: "Press Banca", videoId: "https://drive.google.com/file/d/1NS075GrkodFk4sNNy2uNZFJgHTPvjcWh/view?usp=drivesdk", description: "El ejercicio rey para pectorales. Press de banca clásico que desarrolla fuerza y masa muscular." },
    { name: "Press de Pecho en Máquina con Discos", videoId: "https://drive.google.com/file/d/1iBzZBR_Hm5lJJb2X_i8XOTdUePS3gGoM/view?usp=drivesdk", description: "Press de pecho en máquina con carga de discos que permite ajustar el peso de forma precisa." },
    { name: "Press de Pecho en Máquina", videoId: "https://drive.google.com/file/d/1sd75Zvm2X9dhb0RwCsUMRVloZIg6uRbG/view?usp=drivesdk", description: "Press de pecho en máquina que proporciona un movimiento guiado y seguro para todos los niveles." },
    { name: "Press de Pecho Inclinado en Máquina con Discos", videoId: "https://drive.google.com/file/d/1E-JiJTMYmlhlrBiRUPclwET4GjjtKtEG/view?usp=drivesdk", description: "Press inclinado en máquina con discos que combina el ángulo inclinado con la precisión de carga." },
    { name: "Press Martillo Acostado con Mancuernas", videoId: "https://drive.google.com/file/d/1fLxLI_G-HX7ycMpe_UxqZAbP-_zukIYd/view?usp=drivesdk", description: "Press con agarre neutro (martillo) que reduce el estrés en hombros y enfatiza diferentes fibras del pecho." }
  ],
  espalda: [
    ...
    { name: "Remo con Mancuerna Unilateral", videoId: "https://drive.google.com/open?id=1zTI6gdMFtbtEhVcYou-HTEvc17gTq3PM&usp=drive_copy", description: "Remo unilateral con mancuerna que permite trabajar cada lado independientemente y corregir desequilibrios." },
    { name: "Remo con Barra", videoId: "https://drive.google.com/open?id=1JaFW-_Xi-eNE1_bwiYecHvLBoy4G3d74&usp=drive_copy", description: "Remo clásico con barra libre. Ejercicio fundamental para desarrollar fuerza y masa en toda la espalda." },
    { name: "Polea al Pecho Supino", videoId: "https://drive.google.com/open?id=1GFhUX_VLBPjeAsr8T-TbI1rLogGrO58u&usp=drive_copy", description: "Jalón al pecho con agarre supino que enfatiza el trabajo de bíceps y la porción inferior del dorsal." },
    { name: "Polea al Pecho Prono", videoId: "https://drive.google.com/open?id=1_jw9RDcRWhuD5pKTeq626WUZJL6-9sb8&usp=drive_copy", description: "Jalón al pecho con agarre prono clásico. Excelente para desarrollar la anchura de la espalda." },
    { name: "Polea al Pecho Prono Cerrado", videoId: "https://drive.google.com/open?id=1I4w_4RUem3aIEV0PS0dmelWbfr10tz2J&usp=drive_copy", description: "Jalón con agarre prono cerrado que cambia el ángulo de tracción y enfatiza diferentes fibras musculares." },
    { name: "Polea al Pecho Prono Abierto", videoId: "https://drive.google.com/open?id=1gTDO_Q3MfhgGkK41ey2iaV3eDBT2ekHW&usp=drive_copy", description: "Jalón con agarre prono amplio que maximiza el trabajo del dorsal ancho y crea anchura." },
    { name: "Polea al Pecho con Triángulo", videoId: "https://drive.google.com/open?id=1m8LAuVpQqtKJB9fTKZV1N9pxqb6hj5t3&usp=drive_copy", description: "Jalón al pecho usando agarre triangular que proporciona un agarre neutro y cómodo." },
    { name: "Jalón al Pecho en Máquina", videoId: "https://drive.google.com/open?id=1k4qwHp5eBLKBmDEwvnp-Mj_vNlIotT1n&usp=drive_copy", description: "Jalón al pecho en máquina específica que guía el movimiento y permite mayor control." },
    { name: "Hiperextensión de 45° (Lumbares)", videoId: "https://drive.google.com/open?id=1ZF9yr2BP0yphb1VyE31GFBiI4JZE4BlS&usp=drive_copy", description: "Hiperextensiones a 45 grados específicas para fortalecer los músculos lumbares y la espalda baja." },
    { name: "Espalda con Polea", videoId: "https://drive.google.com/open?id=19I2YycnYqdh3z13mHaiL0M1OrnzGke-E&usp=drive_copy", description: "Ejercicio general de espalda en polea que permite trabajar desde diferentes ángulos." },
    { name: "Encogimientos con Mancuernas (Trapecios) 25° hacia Adelante", videoId: "https://drive.google.com/open?id=1VF3vmqB2a77neHRa5LzeK2QsCiIUSOZK&usp=drive_copy", description: "Encogimientos con mancuernas con inclinación hacia adelante que maximiza la activación de los trapecios." },
    { name: "Encogimientos con Barra (Trapecios) 25° hacia Adelante", videoId: "https://drive.google.com/open?id=1UyFUZjKcd0uQTY7ClyLW0WJwFfFrDnAe&usp=drive_copy", description: "Encogimientos con barra inclinados hacia adelante para desarrollo completo de los músculos trapecios." },
    { name: "Dominadas Agarre Supino", videoId: "https://drive.google.com/file/d/1iv4uVOVyUJnv4S1TbVX4bXxL_Z0FcpI-/view?usp=drivesdk", description: "Dominadas con agarre supino que enfatizan el trabajo de bíceps y la porción inferior del dorsal." },
    { name: "Dominadas Agarre Prono", videoId: "https://drive.google.com/file/d/1REN0E_arkYRaRmUbe-ERu4M28NPv6DrS/view?usp=drivesdk", description: "Dominadas clásicas con agarre prono. El ejercicio rey para desarrollar fuerza y anchura en la espalda." },
    { name: "Dominadas Agarre Prono a los Hombros", videoId: "https://drive.google.com/file/d/1avpp8w_3ezj1jgvDN1sMlOz6K0zRYQj2/view?usp=drivesdk", description: "Dominadas con agarre prono llevando la barra hasta los hombros para mayor activación muscular." },
  ],
  hombros: [
